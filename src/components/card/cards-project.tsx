...
const CardsProjects = ({
  ...
  return (
    <Link href={role === 'admin' ? "/dashboard/projets/" + dataItem?.uniqueId : "/projets/" + dataItem?.uniqueId } className={'flex flex-col items-start text-start gap-2 w-full max-w-full xl:max-w-full md:max-w-sm' + " " + className}>
