...
export default function Home() {
  return (
    <div className="w-full bg-white dark:bg-black overflow-x-hidden" >
      ...
      <div className="flex max-w-7xl mx-auto px-4 w-full min-h-screen justify-center items-center" id="home">
      ...
      <div className="md:w-full w-screen relative flex justify-center h-screen" id="about">
        <div className="absolute max-w-7xl mx-auto top-0 z-30 px-4 md:px-40 text-center flex flex-col gap-10 md:gap-20 h-full justify-center items-center w-full">
      ...
      <div className="w-full py-20" id="projects">
        <div className="px-4 text-end max-w-7xl mx-auto flex flex-col h-full items-end w-full justify-start">
          ...
          <LoadNews pagination={6} pageIndicator={false} className="mt-20"/>
      ...
      <div className="w-full py-20" id="news">
        <div className="px-4 max-w-7xl mx-auto text-end grid grid-cols-1 gap-4 md:grid-cols-3 h-full items-start w-full justify-start">
          ...
          <LoadNews pagination={6} pageIndicator={false} className="col-span-3" />
      ...
      <div className="w-full py-20 relative h-screen flex justify-center" id="internship">
        <div className="max-w-7xl mx-auto px-4 text-end z-20 flex absolute top-0 flex-col h-full items-center w-full justify-center">
      ...
      <div className="w-full py-20" id="contact">
        <div className="max-w-7xl mx-auto px-4 text-end flex flex-col h-full items-start w-full justify-start">
      ...
      <footer className="w-full py-10" id="footer">
        <div className="max-w-7xl mx-auto px-4 flex items-start w-full">
          <div>
