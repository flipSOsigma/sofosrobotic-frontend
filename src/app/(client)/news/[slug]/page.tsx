  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const updateRes = await fetch("/api/news/" + path + "/views", {
          method: "PUT",
        });
  ...
  return (
    <div className="w-full bg-white dark:bg-black overflow-x-hidden min-h-screen pb-20">
      ...
      <div className="md:w-full w-screen flex justify-center relative h-80" id="about">
        ...
        <Silk speed={5} scale={1} color="#7B7481" noiseIntensity={1.5} rotation={0} className="opacity-40" />
      </div>
            ...
            <div className="w-full flex flex-col">
              <div className="flex flex-col w-full gap-4 mb-10 justify-start mt-5">
                ...
                <div className="flex gap-2 items-center">
                  <div className="aspect-square w-12 bg-muted-foreground rounded-full border">{/* <img alt="" /> */}</div>
